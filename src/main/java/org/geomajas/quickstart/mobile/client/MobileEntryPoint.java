...
import org.geomajas.quickstart.mobile.client.activity.mapper.phone.PhoneActivityMapper;
import org.geomajas.quickstart.mobile.client.animation.mapper.PhoneAnimationMapper;
...
public class MobileEntryPoint implements EntryPoint {
	...
	private void createPhoneDisplay(MobileAppFactory mobileAppFactory) {
		...
		AnimatingActivityManager activityManager =
				new AnimatingActivityManager(appActivityMapper, appAnimationMapper, mobileAppFactory.getEventBus());
